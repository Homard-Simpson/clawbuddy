...
def get_sound_files(directory):
    """Return sound files in a directory."""
...
def generate_header(lang_code, output_path):
    ...
    # Merge strings: en-US base, selected language overrides
    ...
    # Collect sound files: en-US base, selected language overrides
    ...
    # Merge sound file list: selected language overrides base language
    ...
    for file in sorted(all_sound_files):
        ...
        # Prefer selected-language audio; fall back to en-US when missing
