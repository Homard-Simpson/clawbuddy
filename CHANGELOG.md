...
- Captured live Xiaozhi prototype voice-input improvement as a ClawBuddy product requirement.
...
- Set separation rule: live Xiaozhi bridge remains operational; ClawBuddy work stays isolated under `products/clawbuddy/`.
...
- Added runtime separation config on non-Xiaozhi ports `8100/8103/8104/8199`.
- Added docs: runtime ports/labels, security model, healthcheck spec, bridge README, demo script.
- Validated with `make test`; live Xiaozhi comparison is read-only and does not mutate the working bridge.
