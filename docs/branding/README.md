...
**Personality:** capable, approachable, privacy-aware, and prototype-honest.
...
| Quiet line | Mist Border | `#CBD5E1` | Card borders, dividers, diagram strokes |
...
Use common, free, system-safe fonts:

- **Headlines:** `Inter`, `SF Pro Display`, `Segoe UI`, `system-ui`, sans-serif.
- **Body:** `Inter`, `SF Pro Text`, `Segoe UI`, `system-ui`, sans-serif.
- **Code and technical labels:** `SFMono-Regular`, `Cascadia Code`, `Menlo`, `Consolas`, monospace.

Default feel: rounded, readable, modern, and not overly futuristic.
...
- Say what the prototype can do in plain language.
- Emphasize reachability, local-first control, and device identity/allowlisting.
- Keep launch copy warm, concise, and concrete.
- Be honest about prototype status.

Avoid:

- Claims that imply production-grade security, medical/safety use, or guaranteed autonomy.
- Generic robot language like “revolutionary AI bot.”
- Private network names, hostnames, device IDs, personal contacts, or deployment details.
...
- Keep clear space around the logo equal to at least the height of the mark’s antenna dot.
- Prefer the full horizontal logo on docs, slides, and launch pages.
- Use the mark by itself for favicons, small avatars, and device-screen mockups.
- Do not rotate, stretch, add drop shadows, or recolor outside the palette without a specific reason.
- On dark backgrounds, place the logo on Night Slate and keep the shell/mint/blue contrast intact.

## Ad and launch copy examples
